...
How many replicates does this experiment have?
...
```{r, warning=FALSE,error=FALSE,message=FALSE}
#### REPLACE THIS TO THE NAME OF THE HOME DIRECTORY ON YOUR COMPUTER
#### (which should be the username for your account on your machine)
myhome <- "OwenW"

# read in the matrix we generated using htseq-count 
cts <- as.matrix(read.table(paste0("/Users/", myhome, "/Desktop/all_counts.txt"), 
...
sra_res <- read.csv(paste0("/Users/", myhome, "/Desktop/sra_result.csv", row.names=1)
head(sra_res)
...
sra_run <- read.csv(paste0("/Users/", myhome, "/Desktop/SraRunInfo.csv"), row.names=1)
head(sra_run)
